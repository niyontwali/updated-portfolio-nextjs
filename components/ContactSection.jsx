            ...
            <div className='p-4'>
              <form>
                ...
                <div className='flex justify-center'>
                  <button className='bg-[#0284c7] hover:bg-[#0a91d5] dark:bg-[#045d8a] dark:hover:bg-[#0679b3] rounded-xl text-lg font-[500] py-2 px-6 text-gray-100 mt-7'>Send Message</button>
                </div>
              </form>
            </div>
          </div>
