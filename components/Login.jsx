        ...
        <div className='mx-4 lg:px-12 flex items-center py-6'>
          <form onSubmit={handleSubmit} className='w-full py-4'>
            <div className='text-center'>
              <p className='text-gray-800 dark:text-gray-300 text-2xl font-bold'>Login</p>
            </div>
            <div>
              {
            ...
            <div className='py-6'>
              <label className='text-lg text-gray-900 dark:text-gray-300 font-[400]'>Email</label>
              <input 
                type="email" 
              ...
              <div className="flex justify-between items-center w-full border-2 border-gray-300 rounded-md px-3 py-[6px] my-2 outline-none dark:border-gray-600 bg-trasparent">
                <input 
                  ...
                  onChange={handleChange}
                />
                <div className="cursor-pointer text-gray-500 dark:text-gray-300" onClick={handleShowPassword}>
                  {showPassword ? (
                    <FaEye />
                  ) : (
                    <FaEyeSlash />
            ...
            <div className='flex justify-center items-center mb-3'>
              <button type="submit" className='px-8 py-2 text-lg font-bold rounded-lg bg-[#0284c7] hover:bg-[#0a91d5] dark:bg-[#045d8a] dark:hover:bg-[#0679b3] text-gray-100'>
                Login 
              </button>
            </div>
          </form>
