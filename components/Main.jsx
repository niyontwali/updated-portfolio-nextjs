    ...
    <div className='bg-dots w-full h-screen pt-16 text-center'>
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center z-30'>
        <div>
          ...
          <p className='text-gray-600 max-w-[70%] m-auto font-[500] dark:text-gray-400'>I love exploring and building exceptional scalable digital experiences. I use JavaScript, TypeScrip and frameworks like Node.js, graphQL, Express, React, Next to develop full-stack web apps. I also use react native and flutter to develop mobile apps.</p>
